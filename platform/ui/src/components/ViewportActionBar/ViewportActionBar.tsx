...
export interface ViewportActionBarProps {
...
const ViewportActionBar = ({
  ...
  const studyDescElemRef = useRef<HTMLElement>(null);
  ...
  const resizeCallback = useCallback(() => {
    ...
    const parentElemRefBBox = rootElemRef.current.getBoundingClientRect();
  ...
  useResizeObserver(rootElemRef?.current, resizeCallback);
