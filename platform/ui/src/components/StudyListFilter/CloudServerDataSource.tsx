...
function CloudServerDataSource({
  onDataSourceAdd,
  extensionManager,
}): ReactElement {
  ...
  return (
    <div className="flex flex-col">
      ...
      <Button
        ...
        className="ml-auto"
        onClick={() => {
          if (extensionManager.dataSourceDefs[name]) {
            const dsDefCopy = JSON.parse(
              JSON.stringify(extensionManager.dataSourceDefs[name])
            );
            dsDefCopy.configuration = {
              ...dsDefCopy.configuration,
              wadoUriRoot: url,
              qidoRoot: url,
              wadoRoot: url,
